								...
								<div class="m-form__section m-form__section--first">
									<div class="form-group m-form__group">
										...
										@if(isset($category['Code']))
											...
											<input class="form-control m-input" type="hidden" placeholder="{{ __('')}}" name="Code" required value="{{$category['Code']}}">
										@else
										   <input class="form-control m-input" type="text" placeholder="{{ __('')}}" name="Code" required>
										@endif
									</div>
									<div class="form-group m-form__group">
										<label for="example-text-input">
										...
										@if(isset($category['Title_Seo']))
											<input class="form-control m-input" type="text" placeholder="{{ __('')}}" name="Title_Seo" required value="{{$category['Title_Seo']}}">
										@else
										   <input class="form-control m-input" type="text" placeholder="{{ __('')}}" name="Title_Seo" required>
										@endif
									</div>
									<div class="form-group m-form__group">
										<label for="example-text-input">
										...
										@if(isset($category['Description_Seo']))
											<textarea class="form-control m-input" placeholder="{{ __('') }}" name="Description_Seo" required>{{$category['Description_Seo']}}</textarea>
										@else
											<textarea class="form-control m-input" placeholder="{{ __('') }}" name="Description_Seo" required rows="6"></textarea>
										@endif
									</div>
									<div class="form-group m-form__group">
										<label for="example-text-input">
