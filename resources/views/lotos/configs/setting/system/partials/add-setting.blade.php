...
<div class="m-portlet m-portlet--tab col-xs-12">
	...
	<form class="m-form m-form--fit m-form--label-align-right" action="" id="setting-form">
		...
		<div class="form-group m-form__group row">
			...
			<input class="form-control m-input m-input--air" type="text" placeholder="{{ __('')}}" name="Code" >
		</div>
		<div class="form-group m-form__group row">
			<label for="example-text-input">
				Value
			</label>
			<input class="form-control m-input m-input--air" type="text" placeholder="{{ __('')}}" name="Value" >
		</div>
		...
		<div class="form-group m-form__group row">
			...
			<textarea class="form-control m-input m-input--air" placeholder="{{ __('') }}" name="Description"></textarea>
		</div>
